...
export default function EventAnalytics({ opportunityId }: AnalyticsProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 sm:p-6">
      ...
      <div className="mb-6 sm:mb-8">
        <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-2 sm:mb-4">Match Status Breakdown</h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          <div className="flex items-center p-2 sm:p-3 bg-yellow-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl font-bold text-yellow-900">{stats.pendingMatches}</p>
            </div>
          </div>
          <div className="flex items-center p-2 sm:p-3 bg-green-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl font-bold text-green-900">{stats.acceptedMatches}</p>
            </div>
          </div>
          <div className="flex items-center p-2 sm:p-3 bg-red-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl font-bold text-red-900">{stats.rejectedMatches}</p>
            </div>
          </div>
        </div>
      </div>
      {/* Recent Matches */}
      <div className="mb-6 sm:mb-8">
        <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-2 sm:mb-4">Recent Matches</h3>
        {matches.length === 0 ? (
