        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-8">
            ...
            <a
              ...
              className="nav-item px-4 py-2 rounded-full border border-blue-200 text-[#2B4B9B] hover:bg-blue-50 font-semibold transition-all duration-300 text-sm lg:text-base"
            >
              Try Live Demo
            </a>
            {!hideAuthButton && (user ? (
              ...
              {!hideAuthButton && (user ? (
                ...
                <>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-4 w-full border border-blue-200 text-[#2B4B9B] font-semibold py-3 px-6 rounded-xl bg-white hover:bg-blue-50 transition-all duration-300 flex items-center justify-center"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Try Live Demo
                  </a>
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium py-3 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center"
                  >
