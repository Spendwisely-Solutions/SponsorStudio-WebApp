...
export default function BookDemo() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!phone || !/^\+[1-9]{1}[0-9]{3,14}$/.test(phone)) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#F8FAFC] via-[#EDF5FD] to-[#E2EEFC] text-[#0A1628] overflow-x-hidden relative font-sans">
      <Helmet>
        <title>Book a Strategy Demo - Sponsor Studio</title>
        <meta name="description" content="Book a free sponsorship strategy demo call. See how Sponsor Studio connects brands and events through AI matching and expert advisory." />
      </Helmet>
      ...
      <NavBar
        ...
        setShowAuthForm={() => navigate('/signin')}
